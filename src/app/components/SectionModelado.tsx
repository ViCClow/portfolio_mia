...
const modelingPhotos = [
  {
    id: "bear-barber",
    src: "https://i.ibb.co/pjnkYWsF/photo-5096194257273859518-y.jpg",
    title: "Bear Barber: Barbería del Ayer",
    category: "Comercial"
  },
  {
    id: "rock",
    src: "https://i.ibb.co/mk5MvQp/DSC00480-ed.jpg",
    title: "Elegancia Eléctrica",
    category: "Colaboración / Polas"
  },
  {
    id: "oldcars",
    src: "https://i.ibb.co/F4MqcmBr/photo-5078274726002011951-y.jpg",
    title: "Legado en Metal",
    category: "Colaboración"
  },
  {
    id: "rio",
    src: "https://i.ibb.co/q39QmSd3/DSC-0061.jpg",
    title: "Misterio del Bío-Bío",
    category: "Colaboración"
  },
  {
    id: "speakeasy",
    src: "https://i.ibb.co/XRywrdg/photo-5078274726002011894-y.jpg",
    title: "Relatos de SpeakEasy",
    category: "Colaboración"
  },
  {
    id: "r2estudio",
    src: "https://i.ibb.co/fY0jLsLz/Lumii-20250617-151653694.jpg",
    title: "Vintage Pin-Up: R2Estudio",
    category: "Colaboración / Pinup"
  },
  {
    id: "libreria",
    src: "https://i.ibb.co/Dqbb6Qy/PHOTO-279.jpg",
    title: "Notas y Letras",
    category: "Colaboración"
  },
  {
    id: "lluvia",
    src: "https://i.ibb.co/4ZfPTsX2/IMG-9772.jpg",
    title: "City Pop Nocturno",
    category: "Colaboración"
  },
  {
    id: "reddress",
    src: "https://i.ibb.co/XrVcX4Qn/photo-5078274726002012171-y.jpg",
    title: "Carmín, Vinilos y Ciudad",
    category: "Personal"
  },
  {
    id: "picnic",
    src: "https://i.ibb.co/2YCWr5Pt/photo-5078274726002012021-y.jpg",
